...
--mesh_depth_path testing/void/void_test_mesh_depth_150.txt \
--validity_map_path testing/void/void_test_validity_map_150.txt \
...
--output_path evaluation_results/void_pretrain \
--device gpu
