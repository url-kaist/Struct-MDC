...
--train_mesh_depth_path training/void/void_train_mesh_depth_150.txt \
--train_validity_map_path training/void/void_train_validity_map_150.txt \
--train_intrinsics_path training/void/void_train_intrinsics_150.txt \
--val_image_path testing/void/void_test_image_150.txt \
--val_mesh_depth_path testing/void/void_test_mesh_depth_150.txt \
--val_validity_map_path testing/void/void_test_validity_map_150.txt \
--val_intrinsics_path testing/void/void_test_intrinsics_150.txt \
...
--checkpoint_path trained_structMDC/void/structMDC_model \
--device gpu \
--n_thread 8
