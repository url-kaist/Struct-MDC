...
class StructMDCModel(object):
    '''
    Struct-MDC Network class
    (Modified from KBNet: Calibrated Backprojection Network class)
    ...
    Arg(s):
        ...
        n_convolution_n_convolution_mesh_depth_refine : int
            number of layers to learn trade off between kernel sizes and near and far structures
        n_filter_mesh_depth_refine : int
            number of filters to use in each convolution in refine mesh depth network
    ...
    def __init__(self,
        ...
        # Build mesh depth refinement network
        self.mesh_depth_refine = networks.RefineMeshDepth(
            image_channels=input_channels_image,
            # depth_channels=input_channels_depth,
            n_filter=n_filter_mesh_depth_refine,
            n_convolution=n_convolution_mesh_depth_refine,
            weight_initializer=weight_initializer,
            activation_func=activation_func)

        # Set up number of input and skip channels
        input_channels_depth = n_filter_mesh_depth_refine
    ...
    def forward(self,
        ...
        Arg(s):
            image : torch.Tensor[float32]
                N x 3 x H x W image
            mesh_depth : torch.Tensor[float32]
                N x 1 x H x W mesh depth generated from (1): structrual sketch
        ...
        input_depth = self.mesh_depth_refine(mesh_depth, image)
    ...
    def parameters(self):
        ...
        parameters = \
            list(self.mesh_depth_refine.parameters()) + \
    ...
    def to(self, device):
        ...
        self.mesh_depth_refine.to(device)
    ...
    def save_model(self, checkpoint_path, step, optimizer):
        ...
        checkpoint['mesh_depth_refine_state_dict'] = self.mesh_depth_refine.state_dict()
    ...
    def data_parallel(self):
        ...
        self.mesh_depth_refine = torch.nn.DataParallel(self.mesh_depth_refine)
