...
PLAD_DATA_150_DIRPATH   = os.path.join(PLAD_ROOT_DIRPATH, '')


PLAD_TRAIN_IMAGE_FILENAME         = 'train_image.txt'
PLAD_TRAIN_MESH_DEPTH_FILENAME    = 'train_mesh_depth.txt'
PLAD_TRAIN_VALIDITY_MAP_FILENAME  = 'train_validity_map.txt'
PLAD_TRAIN_GROUND_TRUTH_FILENAME  = 'train_ground_truth.txt'
PLAD_TRAIN_INTRINSICS_FILENAME    = 'train_intrinsics.txt'
PLAD_TEST_IMAGE_FILENAME          = 'test_image.txt'
PLAD_TEST_MESH_DEPTH_FILENAME     = 'test_mesh_depth.txt'
PLAD_TEST_VALIDITY_MAP_FILENAME   = 'test_validity_map.txt'
PLAD_TEST_GROUND_TRUTH_FILENAME   = 'test_ground_truth.txt'
PLAD_TEST_INTRINSICS_FILENAME     = 'test_intrinsics.txt'

TRAIN_REFS_DIRPATH      = os.path.join('training', 'plad')
TEST_REFS_DIRPATH       = os.path.join('testing', 'plad')

# PLAD training set 150 density
PLAD_TRAIN_IMAGE_150_FILEPATH           = os.path.join(TRAIN_REFS_DIRPATH, 'plad_train_image_150.txt')
PLAD_TRAIN_MESH_DEPTH_150_FILEPATH      = os.path.join(TRAIN_REFS_DIRPATH, 'plad_train_mesh_depth_150.txt')
PLAD_TRAIN_VALIDITY_MAP_150_FILEPATH    = os.path.join(TRAIN_REFS_DIRPATH, 'plad_train_validity_map_150.txt')
PLAD_TRAIN_GROUND_TRUTH_150_FILEPATH    = os.path.join(TRAIN_REFS_DIRPATH, 'plad_train_ground_truth_150.txt')
PLAD_TRAIN_INTRINSICS_150_FILEPATH      = os.path.join(TRAIN_REFS_DIRPATH, 'plad_train_intrinsics_150.txt')
# PLAD testing set 150 density
PLAD_TEST_IMAGE_150_FILEPATH            = os.path.join(TEST_REFS_DIRPATH, 'plad_test_image_150.txt')
PLAD_TEST_MESH_DEPTH_150_FILEPATH       = os.path.join(TEST_REFS_DIRPATH, 'plad_test_mesh_depth_150.txt')
PLAD_TEST_VALIDITY_MAP_150_FILEPATH     = os.path.join(TEST_REFS_DIRPATH, 'plad_test_validity_map_150.txt')
PLAD_TEST_GROUND_TRUTH_150_FILEPATH     = os.path.join(TEST_REFS_DIRPATH, 'plad_test_ground_truth_150.txt')
PLAD_TEST_INTRINSICS_150_FILEPATH       = os.path.join(TEST_REFS_DIRPATH, 'plad_test_intrinsics_150.txt')
# PLAD unused testing set 150 density
PLAD_UNUSED_IMAGE_150_FILEPATH          = os.path.join(TEST_REFS_DIRPATH, 'plad_unused_image_150.txt')
PLAD_UNUSED_MESH_DEPTH_150_FILEPATH     = os.path.join(TEST_REFS_DIRPATH, 'plad_unused_mesh_depth_150.txt')
PLAD_UNUSED_VALIDITY_MAP_150_FILEPATH   = os.path.join(TEST_REFS_DIRPATH, 'plad_unused_validity_map_150.txt')
PLAD_UNUSED_GROUND_TRUTH_150_FILEPATH   = os.path.join(TEST_REFS_DIRPATH, 'plad_unused_ground_truth_150.txt')
PLAD_UNUSED_INTRINSICS_150_FILEPATH     = os.path.join(TEST_REFS_DIRPATH, 'plad_unused_intrinsics_150.txt')
...
def process_frame(inputs):
    ...
    # Set output paths
    image_outpath = os.path.join(PLAD_OUTPUT_DIRPATH, image_refpath)
...
data_dirpaths = [
    PLAD_DATA_150_DIRPATH
]

train_output_filepaths = [
    [
        PLAD_TRAIN_IMAGE_150_FILEPATH,
        PLAD_TRAIN_MESH_DEPTH_150_FILEPATH,
        PLAD_TRAIN_VALIDITY_MAP_150_FILEPATH,
        PLAD_TRAIN_GROUND_TRUTH_150_FILEPATH,
        PLAD_TRAIN_INTRINSICS_150_FILEPATH
    ]
]
test_output_filepaths = [
    [
        PLAD_TEST_IMAGE_150_FILEPATH,
        PLAD_TEST_MESH_DEPTH_150_FILEPATH,
        PLAD_TEST_VALIDITY_MAP_150_FILEPATH,
        PLAD_TEST_GROUND_TRUTH_150_FILEPATH,
        PLAD_TEST_INTRINSICS_150_FILEPATH
    ]
]
unused_output_filepaths = [
    [
        PLAD_UNUSED_IMAGE_150_FILEPATH,
        PLAD_UNUSED_MESH_DEPTH_150_FILEPATH,
        PLAD_UNUSED_VALIDITY_MAP_150_FILEPATH,
        PLAD_UNUSED_GROUND_TRUTH_150_FILEPATH,
        PLAD_UNUSED_INTRINSICS_150_FILEPATH
    ]
]
...
for data_dirpath, train_filepaths, test_filepaths, unused_filepaths in data_filepaths:
    # Training set
    train_image_filepath = os.path.join(data_dirpath, PLAD_TRAIN_IMAGE_FILENAME)
    train_mesh_depth_filepath = os.path.join(data_dirpath, PLAD_TRAIN_MESH_DEPTH_FILENAME)
    train_validity_map_filepath = os.path.join(data_dirpath, PLAD_TRAIN_VALIDITY_MAP_FILENAME)
    train_ground_truth_filepath = os.path.join(data_dirpath, PLAD_TRAIN_GROUND_TRUTH_FILENAME)
    train_intrinsics_filepath = os.path.join(data_dirpath, PLAD_TRAIN_INTRINSICS_FILENAME)
    ...
    # Testing set
    test_image_filepath = os.path.join(data_dirpath, PLAD_TEST_IMAGE_FILENAME)
    test_mesh_depth_filepath = os.path.join(data_dirpath, PLAD_TEST_MESH_DEPTH_FILENAME)
    test_validity_map_filepath = os.path.join(data_dirpath, PLAD_TEST_VALIDITY_MAP_FILENAME)
    test_ground_truth_filepath = os.path.join(data_dirpath, PLAD_TEST_GROUND_TRUTH_FILENAME)
    test_intrinsics_filepath = os.path.join(data_dirpath, PLAD_TEST_INTRINSICS_FILENAME)
    ...
    for seq_dirpath in seq_dirpaths:
        ...
        intrinsics_outpath = \
            os.path.join(PLAD_OUTPUT_DIRPATH, intrinsics_refpath[:-3]+'npy')
        image_out_dirpath = \
    ...
    plad_train_image_filepath, \
        plad_train_mesh_depth_filepath, \
        plad_train_validity_map_filepath, \
        plad_train_ground_truth_filepath, \
        plad_train_intrinsics_filepath = train_filepaths

    print('Storing {} training image file paths into: {}'.format(
        len(train_image_outpaths), plad_train_image_filepath))
    data_utils.write_paths(
        plad_train_image_filepath, train_image_outpaths)

    print('Storing {} training sparse depth file paths into: {}'.format(
        len(train_mesh_depth_outpaths), plad_train_mesh_depth_filepath))
    data_utils.write_paths(
        plad_train_mesh_depth_filepath, train_mesh_depth_outpaths, USE_MESH)

    print('Storing {} training validity map file paths into: {}'.format(
        len(train_validity_map_outpaths), plad_train_validity_map_filepath))
    data_utils.write_paths(
        plad_train_validity_map_filepath, train_validity_map_outpaths)

    print('Storing {} training groundtruth depth file paths into: {}'.format(
        len(train_ground_truth_outpaths), plad_train_ground_truth_filepath))
    data_utils.write_paths(
        plad_train_ground_truth_filepath, train_ground_truth_outpaths)

    print('Storing {} training camera intrinsics file paths into: {}'.format(
        len(train_intrinsics_outpaths), plad_train_intrinsics_filepath))
    data_utils.write_paths(
        plad_train_intrinsics_filepath, train_intrinsics_outpaths)

    plad_test_image_filepath, \
        plad_test_mesh_depth_filepath, \
        plad_test_validity_map_filepath, \
        plad_test_ground_truth_filepath, \
        plad_test_intrinsics_filepath = test_filepaths

    print('Storing {} testing image file paths into: {}'.format(
        len(test_image_outpaths), plad_test_image_filepath))
    data_utils.write_paths(
        plad_test_image_filepath, test_image_outpaths)

    print('Storing {} testing sparse depth file paths into: {}'.format(
        len(test_mesh_depth_outpaths), plad_test_mesh_depth_filepath))
    data_utils.write_paths(
        plad_test_mesh_depth_filepath, test_mesh_depth_outpaths, USE_MESH)

    print('Storing {} testing validity map file paths into: {}'.format(
        len(test_validity_map_outpaths), plad_test_validity_map_filepath))
    data_utils.write_paths(
        plad_test_validity_map_filepath, test_validity_map_outpaths)

    print('Storing {} testing groundtruth depth file paths into: {}'.format(
        len(test_ground_truth_outpaths), plad_test_ground_truth_filepath))
    data_utils.write_paths(
        plad_test_ground_truth_filepath, test_ground_truth_outpaths)

    print('Storing {} testing camera intrinsics file paths into: {}'.format(
        len(test_intrinsics_outpaths), plad_test_intrinsics_filepath))
    data_utils.write_paths(
        plad_test_intrinsics_filepath, test_intrinsics_outpaths)

    plad_unused_image_filepath, \
        plad_unused_mesh_depth_filepath, \
        plad_unused_validity_map_filepath, \
        plad_unused_ground_truth_filepath, \
        plad_unused_intrinsics_filepath = unused_filepaths

    print('Storing {} unused testing image file paths into: {}'.format(
        len(unused_image_outpaths), plad_unused_image_filepath))
    data_utils.write_paths(
        plad_unused_image_filepath, unused_image_outpaths)

    print('Storing {} unused testing sparse depth file paths into: {}'.format(
        len(unused_mesh_depth_outpaths), plad_unused_mesh_depth_filepath))
    data_utils.write_paths(
        plad_unused_mesh_depth_filepath, unused_mesh_depth_outpaths, USE_MESH)

    print('Storing {} unused testing validity map file paths into: {}'.format(
        len(unused_validity_map_outpaths), plad_unused_validity_map_filepath))
    data_utils.write_paths(
        plad_unused_validity_map_filepath, unused_validity_map_outpaths)

    print('Storing {} unused testing groundtruth depth file paths into: {}'.format(
        len(unused_ground_truth_outpaths), plad_unused_ground_truth_filepath))
    data_utils.write_paths(
        plad_unused_ground_truth_filepath, unused_ground_truth_outpaths)

    print('Storing {} unused testing camera intrinsics file paths into: {}'.format(
        len(unused_intrinsics_outpaths), plad_unused_intrinsics_filepath))
    data_utils.write_paths(
        plad_unused_intrinsics_filepath, unused_intrinsics_outpaths)
