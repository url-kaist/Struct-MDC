...
dataset_name = 'void_parsed_line'
unused_img = 0

USE_MESH = True # turn off if only line is used


VOID_ROOT_DIRPATH       = os.path.join('data', dataset_name)
VOID_OUTPUT_DIRPATH     = os.path.join('data', 'void_structMDC')

VOID_DATA_150_DIRPATH   = os.path.join(VOID_ROOT_DIRPATH, '')


VOID_TRAIN_IMAGE_FILENAME         = 'train_image.txt'
VOID_TRAIN_MESH_DEPTH_FILENAME    = 'train_mesh_depth.txt'
...
VOID_TEST_MESH_DEPTH_FILENAME     = 'test_mesh_depth.txt'
...
VOID_TRAIN_MESH_DEPTH_150_FILEPATH      = os.path.join(TRAIN_REFS_DIRPATH, 'void_train_mesh_depth_150.txt')
...
VOID_TEST_MESH_DEPTH_150_FILEPATH       = os.path.join(TEST_REFS_DIRPATH, 'void_test_mesh_depth_150.txt')
...
VOID_UNUSED_MESH_DEPTH_150_FILEPATH     = os.path.join(TEST_REFS_DIRPATH, 'void_unused_mesh_depth_150.txt')
...
train_output_filepaths = [
    [
        ...
        VOID_TRAIN_MESH_DEPTH_150_FILEPATH,
...
test_output_filepaths = [
    [
        ...
        VOID_TEST_MESH_DEPTH_150_FILEPATH,
...
unused_output_filepaths = [
    [
        ...
        VOID_UNUSED_MESH_DEPTH_150_FILEPATH,
...
for data_dirpath, train_filepaths, test_filepaths, unused_filepaths in data_filepaths:
    ...
    train_mesh_depth_filepath = os.path.join(data_dirpath, VOID_TRAIN_MESH_DEPTH_FILENAME)
    ...
    test_mesh_depth_filepath = os.path.join(data_dirpath, VOID_TEST_MESH_DEPTH_FILENAME)
    ...
    void_train_image_filepath, \
        void_train_mesh_depth_filepath, \
    ...
    print('Storing {} training sparse depth file paths into: {}'.format(
        len(train_mesh_depth_outpaths), void_train_mesh_depth_filepath))
    data_utils.write_paths(
        void_train_mesh_depth_filepath, train_mesh_depth_outpaths, USE_MESH)
    ...
    print('Storing {} testing sparse depth file paths into: {}'.format(
        len(test_mesh_depth_outpaths), void_test_mesh_depth_filepath))
    data_utils.write_paths(
        void_test_mesh_depth_filepath, test_mesh_depth_outpaths, USE_MESH)
    ...
    void_unused_image_filepath, \
        void_unused_mesh_depth_filepath, \
    ...
    print('Storing {} unused testing sparse depth file paths into: {}'.format(
        len(unused_mesh_depth_outpaths), void_unused_mesh_depth_filepath))
    data_utils.write_paths(
        void_unused_mesh_depth_filepath, unused_mesh_depth_outpaths, USE_MESH)
